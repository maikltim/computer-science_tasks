...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname exercise_05) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;; Exercise 5.
...
(define LEAVES (pulled-regular-polygon (/ HEIGHT 8) 10 1.5 120 "solid" "darkgreen"))
